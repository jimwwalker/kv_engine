...
TYPED_TEST(UnsignedLeb128, canonical_only) {
    ...
    std::vector<uint8_t> leb_8 = {{0xff, 0x00}}; //  non-canonical 0x7f
    std::vector<uint8_t> leb_16 = {{0xff, 0xff, 0x00}};
    // 11210 should be 0xca,0x57
    std::vector<uint8_t> leb_32 = {{0xca, 0xD7, 0x80, 0x00}}; // 11210
    std::vector<uint8_t> leb_3 = {{0xff, 0x00}};
