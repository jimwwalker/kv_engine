...
public:
    ...
    // Tests need dummy entries which appear in default and 'shop1' scopes
    Collections::VB::ManifestEntry entryInDefaultScope{
            manager->createOrReferenceMeta(CollectionID::Default,
                                           {"name1", ScopeID::Default, {}}),
            0};
    Collections::VB::ManifestEntry entryInShop1Scope{
            manager->createOrReferenceMeta(CollectionID::Default,
