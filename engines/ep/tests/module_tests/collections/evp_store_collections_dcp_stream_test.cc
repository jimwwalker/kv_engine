...
TEST_F(CollectionsDcpStreamsTest, two_streams) {
    ...
    EXPECT_EQ(DcpStreamId(88), producers->last_stream_id);
    ...
    EXPECT_EQ(DcpStreamId(32), producers->last_stream_id);
...
TEST_F(CollectionsDcpStreamsTest, two_streams_different) {
    ...
    EXPECT_EQ(
            ...
            producer->stepAndExpect(producers.get(),
                                    cb::mcbp::ClientOpcode::DcpSnapshotMarker));
    EXPECT_EQ(DcpStreamId(101), producers->last_stream_id);
    ...
    EXPECT_EQ(mcbp::systemevent::id::CreateCollection,
              producers->last_system_event);
    EXPECT_EQ(DcpStreamId(2018), producers->last_stream_id);
