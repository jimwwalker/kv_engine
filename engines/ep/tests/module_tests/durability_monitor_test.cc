...
void PassiveDurabilityMonitorTest::addSyncWrite(
    ...
    vb->checkpointManager->createSnapshot(
            seqno, seqno, {} /*HCS*/, CheckpointType::Memory, 0);
    processSet(item);
}
