 ...
 */
std::variant<cb::engine_errc, nlohmann::json> prepare(KVStoreIface& kvs,
                                                      std::string_view path,
                                                      Vbid vbid);

/**
 * Release a snapshot associated with the uuid
 *
 * @param path base path for snapshots
 *
 */
cb::engine_errc release(std::string_view path, std::string_view uuid);

/**
 * Release a snapshot associated with the vb
 *
 * @param path base path for snapshots
 * @param vbid vbucket to look for
 */
cb::engine_errc release(std::string_view path, Vbid vbid);
