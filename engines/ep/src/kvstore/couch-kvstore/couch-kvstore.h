...
public:
    ...
    std::pair<cb::engine_errc, std::vector<snapshot::FileInfo>> prepareSnapshot(
...
protected:
     ...
     * @return CompactDBStatus indicating the compaction outcome
     */
    CompactDBStatus compactDBInternal(DbHolder& sourceDb,
