...
inline bool unsigned_leb128<uint8_t>::is_canonical(uint64_t value,
    ...
    return (encodedLength == 2 && value > 127) || encodedLength == 1;
}
...
inline bool unsigned_leb128<uint16_t>::is_canonical(uint64_t value,
    ...
    return encodedLength == 3 && value > 16383;
}
...
inline bool unsigned_leb128<uint64_t>::is_canonical(uint64_t value,
    ...
    switch (encodedLength) {
    case 6:
        return value > 34359738367;
    case 7:
        return value > 4398046511103;
    case 8:
        return value > 562949953421311;
    case 9:
        return value > 7205759403792793;
    case 10:
