 ...
 *
 * 2.x first adds a 1byte version field + 1b
 * 2.0 = MVS/HCS  (durability in server 6.5) + 16b
 * 2.1 = MVS/HCS/Timestamp (was for PITR not used) + 24b
 * 2.2 = MVS/HCS/PurgeSeqno (8.0) + 24b
 *
 * 2.1 is dropped, never sent unless PITR was enabled, which was never enabled
 * outside of testing.
 */
...
enum class id : uint32_t {
    BeginCollection =
            0, // Since 7.0 (epoch of SystemEvents)
    ...
    EndCollection = 1, // Since 7.0 (epoch of SystemEvents)
